...
# 
api_key="42d17e33ea44cbb4c030600e4b5231f71908810230" 			#api_key
api_token="ebccae9238cecc16222b92328f963dfc1164684573" 	#api_token
url="http://www.mengyu520.com/server/index.php?s=/api/open/fromComments" #同步到的url。使用www.showdoc.cc的不需要修改，使用开源版的请修改
#
#
#
#
